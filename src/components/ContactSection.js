...
const ContactSection = () => {
  return (
    <section id="contact" className="bg-zinc-950 relative overflow-hidden py-14 md:py-20 pt-28 md:pt-32"
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif font-bold text-transparent bg-clip-text bg-gradient-to-r from-red-500 via-yellow-400 to-red-500 mb-6">
        ...
        <div className="max-w-6xl mx-auto mb-16">
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="bg-zinc-900/70 backdrop-blur-sm rounded-2xl p-5 sm:p-6 md:p-8 shadow-2xl border border-yellow-600/30"
          >
            <div className="flex items-center justify-center mb-6">
              <span className="text-5xl sm:text-6xl">🎋</span>
            </div>
            <h3 className="text-2xl sm:text-3xl font-serif font-bold text-center text-yellow-400 mb-6">
              "Ngoại giao cây tre"
            </h3>
            <p className="text-base sm:text-lg font-sans text-gray-300 leading-relaxed mb-6 text-center max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-4 sm:gap-6 mt-8">
              <motion.div
                ...
                className="bg-gradient-to-br from-green-900/40 to-emerald-900/40 p-5 sm:p-6 rounded-xl shadow-md border border-green-600/30 backdrop-blur-sm"
              >
        ...
        <div className="max-w-6xl mx-auto mb-16">
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="bg-zinc-900/70 backdrop-blur-sm rounded-2xl p-5 sm:p-6 md:p-8 shadow-2xl border border-yellow-600/30 space-y-6"
          >
            ...
            <div className="bg-red-900/30 rounded-xl p-5 sm:p-6 border-l-4 border-red-500 backdrop-blur-sm">
              <h4 className="font-serif font-bold text-red-400 mb-3 text-lg sm:text-xl">🛡️ Về đấu tranh và bảo vệ Tổ quốc</h4>
            ...
            <div className="bg-sky-900/30 rounded-xl p-5 sm:p-6 border-l-4 border-sky-500 backdrop-blur-sm">
              <h4 className="font-serif font-bold text-sky-400 mb-3 text-lg sm:text-xl">🏛️ Về xây dựng Chủ nghĩa xã hội</h4>
              <p className="text-gray-300 font-sans text-sm sm:text-base leading-relaxed">
            ...
            <div className="bg-yellow-900/30 rounded-xl p-5 sm:p-6 border-l-4 border-yellow-500 backdrop-blur-sm">
              <h4 className="font-serif font-bold text-yellow-400 mb-3 text-lg sm:text-xl">🚀 Dẫn chứng thực tiễn</h4>
              <p className="text-gray-300 font-sans text-sm sm:text-base leading-relaxed">
